...
Unit_Matrix, Unit_TextureManager, DeCAL, Unit_Rasterer, Unit_LightNodes;
  ...
  type
    ...
    TModel = class (TObject)
           ...
           public
              FLightSourceOptions: TLightSourceOptions; // I know, that is bad style ;)
              ...
              constructor CreateFrom3DS (AModelID: Cardinal; FileName: String);
...
type
    ...
    constructor TModel.CreateFrom3DS (AModelID: Cardinal; FileName: String);
    var
       DataFile: TFile3DS;
       Mesh: PMesh3DS;
       DataFace: TFace3DS;
    ...
    begin
        ...
        try
            ...
            SetVector(MaxP, -10000, -10000, -10000);
            SetVector(MinP, 10000, 10000, 10000);
